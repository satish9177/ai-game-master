 ...
 * - 'interactable' — scroll; crate/barrel/debris/barricade/zombie with non-exit
 ...
 * - 'decorative'   — pillar, arch (no exit), prop, rug, and crate/barrel/debris/
 *                    barricade/zombie without interaction: relocated to side zones
 *                    when in the corridor.
 */
